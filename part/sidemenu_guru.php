<ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa ti-id-badge"></i><a href="<?php echo $siteurl; ?>/views/jurnalkelas/guru/jurnalkelas.php">Jurnal Kelas</a></li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="menu-icon fa fa-file-text"></i><a href="<?php echo $siteurl; ?>/views/e-learning/guru/data-nilai.php">Daftar Nilai</a></li>
                        </ul>
                    </li>
                    <li>
