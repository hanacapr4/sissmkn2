                                        ...
                                        <div class="col-xl-12 col-lg-6">
                                            <section class="card">
                                                <div class="twt-feed blue-bg" style="background-color:#13b4a0">
                                                    ...
                                                    <img class="align-self-center rounded-circle mr-3" style="margin-left:40%; margin-bottom:2%; width:200px; height:200px;" alt="" src="<?php echo $siteurl; ?>/images/guru.jpg">
                                                    </div>
                                                </div>
