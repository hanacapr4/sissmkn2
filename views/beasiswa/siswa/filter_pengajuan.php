                  ...
                  <div class="col-md-12">
                    <div class="card">
                        <div class="card-footer">
                                        ...
                                        <button type="button" title="Eksport" class="btn btn-success btn-sm"><i class="fa fa-upload"></i>&nbsp; Eksport</button>
                        ...
                        <div class="card-body">
                          <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                ...
                                <?php
                                	...
                                	// $azmulai = $_GET['azmulai'];
                                	// $azhingga = $_GET['azhingga'];
                                	// $azperiode = $_GET['azperiode'];
                                	// print_r($_GET['azmulai']);
                                	// print_r($_GET['azhingga']);
                                	// print_r($_GET['azperiode']);
