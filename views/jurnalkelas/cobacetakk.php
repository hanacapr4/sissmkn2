...
$sis=mysqli_fetch_array(mysqli_query($con,"SELECT * FROM t_sis_thajar where c_siswa='$_GET[siswa]' "));
$content.='
...
$kel=mysqli_fetch_array(mysqli_query($con,"SELECT * FROM t_kelas where c_kelas='$akh[c_kelas]' "));
