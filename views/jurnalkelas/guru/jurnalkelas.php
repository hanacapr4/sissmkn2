                  ...
                  <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                          <!-- <a href="index2.php"><button title="export data berupa excel" type="submit" class="btn btn-success btn-sm">
                            <i class="fa ti-upload"></i> Rekapitulasi Jurnal
                          </button> -->
                          </a>
                          ...
                          <!-- <a href="cetakjurnal.php"><button title="Tambahkan surat keluar" type="reset" class="btn btn-danger btn-sm"><i class="fa ti-export"></i> Print Test 1
                          </button></a> -->
                        </div>
                        <!--<div class="card-header">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a style = "margin-right:3px;" href="editjurnal.php?id_jurnal=<?= $item['id_jurnal']; ?>&&userid=<?= $item['userid']?>"><button type="" class="btn btn-warning btn-sm"><i class="fa fa-pencil"></i> Edit</button></a><br><br>
