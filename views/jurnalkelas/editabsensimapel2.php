                          ...
                          <table id="bootstrap-data-table" class="table table-striped table-bordered display">
                                <thead>
                                  ...
                                  <tbody>
                                    ...
                                    <td>
                                    <a style = "margin-right:3px;" href="tambahabsenmapel.php?no_induk=<?= $item['no_induk'];?>&&tglabsen=<?=$date;?>"><button type="" class="btn btn-warning btn-sm"><i class="fa fa-pencil"></i>Edit Absensi</button></a>
                                    </td>
                                </tr>
