                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <li><a href="absensimapel.php">Absensi per Mata Pelajaran</a></li>
                          ...
                          <table id="bootstrap-data-table" class="table table-striped table-bordered">
                               ...
                               <tr>
                                   ...
                                   <td>
                                      ...
                                      <a style = "margin-right:3px;" href="editabsensimapel2.php?id_kelas=<?= $item['id_kelas'];?>&&tglabsen=<?=$date;?>"<button type="" class="btn btn-warning btn-sm"><i class="fa fa-pencil"></i> Edit Absensi</button></a>
