                        ...
                        <div class="card-body">
                          <table id="coba" class="table table-striped table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td><a style = "margin-right:3px;" href="edit_pendaftaran.php?user_id=<?= $item['user_id'];?>"<button type="" class="btn btn-warning btn-sm"><i class="fa fa-pencil"></i> Daftar Ulang</button></a>
                                      </td>
                                    </td>
                                </tr>
                                <?php } ?>
