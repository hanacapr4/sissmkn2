                                  ...
                                  ?>
                                      ...
                                      <div class="row" style = "margin-top:13px;">
                                          <div class="col-6">
                                            ...
                                            <div class="col-12 col-md-9"><input type="number" name="nisn" value="<?= $item['nisn']; ?>"  class="form-control"></div>
                                          </div>
                                          <div class="col-6">
                                      ...
                                      <div class="row" style = "margin-top:5px;">
                                          <div class="col-6">
                                            ...
                                            <div class="col-12 col-md-9"><input type="date" id="disabled-input" name="tglLahir" value="<?= $item['tglLahir']; ?>" class="form-control"></div>
                                          </div>
                                          <div class="col-6">
                                              <div class="col col-md-3"><label for="text-input" class=" form-control-label">Tempat Lahir</label></div>
                                              <div class="col-12 col-md-9"><input type="text" id="text-input" name="tempatLahir" value="<?= $item['tempatLahir']; ?>" class="form-control"></div>
                                          </div>
                                      </div>
                                      <div class="row" style = "margin-top:13px;">
                                          <div class="col-6">
                                      ...
                                      <div class="row" style = "margin-top:13px;">
                                          <div class="col-6">
                                            ...
                                            <div class="col-12 col-md-9"><input type="text" id="disabled-input" name="kabupaten" value="<?= $item['kabupaten']; ?>" class="form-control"></div>
                                          </div>
                                          <div class="col-6">
                                              <div class="col col-md-3"><label for="text-input" class=" form-control-label">Telepon</label></div>
                                              <div class="col-12 col-md-9"><input type="number" id="text-input" name="telepon" value="<?= $item['telepon']; ?>" class="form-control"></div>
                                          </div>
                                      </div>
                                      <div class="row" style = "margin-top:13px;">
                                          <div class="col-6">
                                          ...
                                          <div class="col-6">
                                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Asal Sekolah</label></div>
                                              <div class="col-12 col-md-9"><input type="text" id="text-input" name="sekolahAsal" value="<?= $item['sekolahAsal']; ?>" class="form-control"></div>  
                                          </div>
                                      </div>
                                      <div class="row" style = "margin-top: 14px;">
                                          <div class="col-6">
                                              <div class="col col-md-3"><label for="text-input" class=" form-control-label">NO Peserta SLTP</label></div>
                                              <div class="col-12 col-md-9"><input type="text" id="text-input" name="noPesertaSLTP" value="<?= $item['noPesertaSLTP']; ?>" class="form-control"></div>
                                            </div>
                                          <div class="col-6">
