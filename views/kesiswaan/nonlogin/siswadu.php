    ...
    background-color: #4CAF50;
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
              <form>
                  <input type="text" name="idpdf" placeholder="Masukkan ID Pendaftaran..">
                  <input type="text" name="tgl" placeholder="Masukkan tanggal lahir">
                  <input type="submit" name="muncul">
                </form>
                <?php
                if (isset($_GET["muncul"])){
                   ?>
                  ...
                  <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                          ...
                          <div id="pay-invoice">
                              <?php
                                    foreach ($kesiswaan->getdetailducs($_GET['idpdf'], $_GET['tgl']) as $item) {
                                  ?>
