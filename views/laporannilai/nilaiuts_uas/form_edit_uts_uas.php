                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <li><a href="transkrip_nilai.php">Transkrip Nilai</a></li>
                            <li class="active">Form Edit Transkrip Nilai</li>
                        </ol>
                    </div>
                </div>
            </div>
                 ...
                 <div class="col-11">
                  <div class="row form-group">
                         <form action="<?php echo $siteurl; ?>/views/nilai/proses_nilai.php?aksi=update" method="post">
                                <?php
                                    foreach ($penilaian->getdata($_GET['id_nilai']) as $item) {
                                  ?>
                                <div class="row form-group">
                          <div class="col col-md-3">
                            <label for="text-input" class=" form-control-label">ID Nilai</label>
                          </div>
                          <div class="col-12 col-md-9"><input type="text" id="disabled-input" name="id_nilai" value="<?= $item['id_nilai']; ?>" class="form-control" readonly></div>
                        </div>
                          <div class="row form-group">
                          <div class="col col-md-3">
