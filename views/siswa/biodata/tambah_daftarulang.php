                  ...
                  <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Form </strong>Tambah Siswa
                        </div>
                        
                          <!-- Credit Card -->
                          <div id="pay-invoice">
                                  <form action="<?php echo $siteurl; ?>/views/kesiswaan/daftarulang/proses.php?aksi=tambah" method="post" class="form-horizontal" id="regForm" enctype="multipart/form-data">
                                      <div class="card-body">
