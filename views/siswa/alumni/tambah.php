                        ...
                        <div class="card-body">
                          ...
                          <div id="pay-invoice">
                              <div class="card-body">
                                  ...
                                  <?php
                                    foreach ($kesiswaan->getdetailalumni($_GET['nis']) as $item) {
                                  ?>
                                      ...
                                      <div class="row" style = "margin-top:13px;">
                                          ...
                                          <div class="col-6">
                                              ...
                                              <div class="col-12 col-md-9"><input type="text" id="text-input" name="namaInstansi" value="" class="form-control"></div>
                                      ...
                                      <div class="row" style = "margin-top:5px;">
                                          <div class="col-6">
                                            ...
                                            <div class="col-12 col-md-9"><input type="number" id="disabled-input" name="penghasilan" value="" class="form-control"></div>
                                          </div>
                                          <div class="col-6">
