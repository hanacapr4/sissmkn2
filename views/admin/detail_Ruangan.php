                          ...
                          $id = $_GET["id"];?>
                                ...
                                ?>
                                          ...
                                          <div class="col-6">
                                              ...
                                              <div class="col-12 col-md-9"><input type="text" id="id" name="id" placeholder="" class="form-control"value="<?= $data['id']; ?>" readonly></div>
                                          </div>
                                      ...
                                      <div class="col-6">
                                          ...
                                          <div class="col-6">
                                              ...
                                              <div class="col-12 col-md-9"><input type="text" id="gedung" name="gedung" placeholder="" class="form-control"value="<?= $data['gedung']; ?>" readonly></div>
                                              </div>
                                          </div>
                                          ...
                                          <div class="col-6">
                                           ...
                                           <div class="col-6">
                                              ...
                                              <div class="col-12 col-md-9"><input type="text" id="penanggung_jawab" name="penanggung_jawab" placeholder="" class="form-control"value="<?= $data['penanggung_jawab']; ?>" readonly></div>
                                              </div>
                                              </div>
