...
class SSP {
     ...
     *
     */
    static function simple ( $request, $sql_details, $table, $primaryKey, $columns, $joinQuery = NULL, $getkelas, $kolkelas, $extraWhere = '', $groupBy = '', $having = '')
    {
        $bindings = array();
       ...
       $having
        ...
        if($getkelas){
            $kelas = SSP::pluck($kolkelas, 'db', $getkelas);
            $querykelas =  "SELECT SQL_CALC_FOUND_ROWS ".implode(", ", $kelas)."
             $getkelas";
        }

        $data = SSP::sql_exec( $db, $bindings,$query);
        $datakelas = SSP::sql_exec( $db, $bindings,$querykelas);
